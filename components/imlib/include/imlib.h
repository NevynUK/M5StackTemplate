...
#define IM_IS_SIGNED(a) (__builtin_types_compatible_p(__typeof__(a), signed) || __builtin_types_compatible_p(__typeof__(a), signed long))
#define IM_IS_UNSIGNED(a) (__builtin_types_compatible_p(__typeof__(a), unsigned) || __builtin_types_compatible_p(__typeof__(a), unsigned long))
...
#define COLOR_BOUND_RGB565(pixel0, pixel1, threshold)                                                                                                                                                                                                                                                      \
    ({                                                                                                                                                                                                                                                                                                     \
        ...
        __typeof__(pixel1) _pixel1 = (pixel1);                                                                                                                                                                                                                                                             \
        __typeof__(threshold) _threshold = (threshold);                                                                                                                                                                                                                                                    \
        (abs(COLOR_RGB565_TO_R5(_pixel0) - COLOR_RGB565_TO_R5(_pixel1)) <= COLOR_RGB565_TO_R5(_threshold)) && (abs(COLOR_RGB565_TO_G6(_pixel0) - COLOR_RGB565_TO_G6(_pixel1)) <= COLOR_RGB565_TO_G6(_threshold)) &&                                                                                        \
...
#define COLOR_GRAYSCALE_TO_RGB565(pixel) COLOR_YUV_TO_RGB565(((pixel) - 128), 0, 0)
    ...
    typedef enum { COLOR_PALETTE_RAINBOW, COLOR_PALETTE_IRONBOW, COLOR_PALETTE_DEPTH, COLOR_PALETTE_EVT_DARK, COLOR_PALETTE_EVT_LIGHT } color_palette_t;
...
#define IMLIB_PIXFORMAT_IS_VALID(x)                                                                                                                                                                                                                                                                        \
    ((x == PIXFORMAT_BINARY) || (x == PIXFORMAT_GRAYSCALE) || (x == PIXFORMAT_RGB565) || (x == PIXFORMAT_ARGB8) || (x == PIXFORMAT_BAYER_BGGR) || (x == PIXFORMAT_BAYER_GBRG) || (x == PIXFORMAT_BAYER_GRBG) || (x == PIXFORMAT_BAYER_RGGB) || (x == PIXFORMAT_YUV422) || (x == PIXFORMAT_YVU422) ||       \
...
#define IMAGE_COMPUTE_YUV_PIXEL_ROW_PTR(image, y)                                                                                                                                                                                                                                                          \
    ...
    void imlib_draw_string(image_t *img, int x_off, int y_off, const char *str, int c, float scale, int x_spacing, int y_spacing, bool mono_space, int char_rotation, bool char_hmirror, bool char_vflip, int string_rotation, bool string_hmirror, bool string_hflip);
