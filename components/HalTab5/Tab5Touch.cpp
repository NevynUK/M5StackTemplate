...
esp_err_t HalTab5::ConfigureTouchPanel()
{
    ...
    tp_cfg.x_max = (uint16_t) (BSP_LCD_H_RES & 0xFFFF);
    tp_cfg.y_max = (uint16_t) (BSP_LCD_V_RES & 0xFFFF);
    tp_cfg.rst_gpio_num = BSP_LCD_TOUCH_RST;
    tp_cfg.int_gpio_num = BSP_LCD_TOUCH_INT;
    tp_cfg.levels = {};
